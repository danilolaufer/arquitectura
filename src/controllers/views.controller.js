...
import { orderService } from "../dao/db/orders.service.js";
import { restoreService } from "../dao/db/restore.service.js";
import documentService from "../dao/db/documents.service.js";
import { usersService } from "../dao/db/users.service.js";
import ViewsService from "../dao/db/views.service.js";
...
export default class ViewsController {
    ...
    async getCurrentUser(req, res) {
        ...
        res.render("current", { style: "./css/index.css", sectionPage: "Current", sessionUser: currentUser, nameShopping: "Danilo" });
        } catch (error) {
